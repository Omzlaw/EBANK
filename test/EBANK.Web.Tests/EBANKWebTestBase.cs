...
{
    public abstract class EBANKWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EBANKWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EBANKWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EBANKDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EBANKDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EBANKDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EBANKDbContext, Task<T>> func)
        {
            T result;
